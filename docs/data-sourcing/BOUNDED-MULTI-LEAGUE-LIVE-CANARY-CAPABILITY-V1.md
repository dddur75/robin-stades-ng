# Bounded Multi-League Live Canary Capability V1

## Statut livré

Cette livraison ajoute une capacité logicielle live, pas une autorisation live.
...
l'installation et les preuves Windows ; ils restent subordonnés au plafond
explicite de quarante minutes du run exact-head demandé par cette mission, et ne
sont pas présentés comme un workload E1 de cinq minutes.
